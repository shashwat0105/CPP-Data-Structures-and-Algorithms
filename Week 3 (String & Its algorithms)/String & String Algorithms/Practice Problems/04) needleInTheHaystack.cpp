...
Solution video: https://youtu.be/CcGcUfLDeH4

// We can use KMP Algorithm

// string find method (may be this is a brute force inbuilt method) TC=O(m*n)
https://youtu.be/hkJT-209AuI
...
// TC of below hashing method code = O(nlogn + m) because we /P^L for that we multply by inverse modulo, that causes a factor of logn
#include<bits/stdc++.h>
