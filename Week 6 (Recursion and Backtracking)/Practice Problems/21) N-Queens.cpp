...
For isValid
It is sufficient to check 3 moves of the queen out of 8
Left
...
// We hash the lowerDiagonal using a vector of size 2n -1
// We hash the upperDiagonal using a vector of size 2n-1
